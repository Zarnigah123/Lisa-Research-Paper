...
%    Hence, the BHBH pairs have the most eccentric pairs having the highest average eccentricity and $\langle M_c\rangle$.
	...
	The particular BHNS pair started off as a ZAMS pair with $\sim$\SI{33.4489}{\Msun} and $\sim$\SI{17.7114}{\Msun} companions, with a semi-major axis of $\sim$\SI{0.6662}{\AU}. 
	The eccentricity and metallicity of the pair at ZAMS was $\sim$\num{0.1534} and $\sim$\num{0.0239}. 
	With lookback and evolution times of 
...
%    Hence, if a source emits in the frequency region of the highest sensitivity of LISA, then it will be detected at a maximum distance.
    ...
    \begin{figure*}[!h]%
    	\centering
    	\includegraphics[width=\textwidth]{analysis_data/dco_type_divergence_in_two_datasets}
