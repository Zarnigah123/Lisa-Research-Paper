...
%    \end{figure}
	...
	\noindent\textbf{[some context here is needed before we discuss comparison]}
	
	A total of 140 seeds were found common between the two data sets. 
	

%	As the goal of the study was to see the affect of $\ecc{ZAMS}$ on the binary's evolution, the binaries were again evolved through LEGWORK for another 100 instances of MW galaxy.
