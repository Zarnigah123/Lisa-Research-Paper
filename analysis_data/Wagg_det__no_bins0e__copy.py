...
input_filepath = "/media/astrophysicsandpython/DATA_DRIVE0/h5out0e.h5"
#input_filepath = "/home/nazeela/.local/share/Trash/files/10Mil/0e/merged/h5out0e.h5"
loops = 100
...
def make_detectable_dataset(input_filepath, loops, binary_type, t_obs, MW_SIZE=1_000_000,
    ...
    for milky_way in range(43, loops):
        ...
        cwd = os.getcwd()
        dir_ = f'./new{binary_type.lower()}0e'
