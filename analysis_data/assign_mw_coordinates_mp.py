...
from utilities import assign_mw_coordinates, chunks
...
_f = [tuple([i, f'{get_dir}{j}', int(j.split('_')[-1].split('.')[0]), cur_, f'./{dco_type}/']) for i, j, k in zip(DCO_files, sim_MW, n_gal)]
